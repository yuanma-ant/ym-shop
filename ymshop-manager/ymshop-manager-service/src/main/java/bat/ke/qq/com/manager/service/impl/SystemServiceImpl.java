...
import bat.ke.qq.com.manager.mapper.TbBaseMapper;
import bat.ke.qq.com.manager.mapper.TbLogMapper;
import bat.ke.qq.com.manager.mapper.TbOrderItemMapper;
import bat.ke.qq.com.manager.mapper.TbShiroFilterMapper;
import bat.ke.qq.com.manager.pojo.*;
import bat.ke.qq.com.manager.service.SystemService;
...
public class SystemServiceImpl implements SystemService {
    ...
    public List<TbShiroFilter> getShiroFilter() {
        ...
        if(list==null){
            throw new YmshopException("获取shiro过滤链失败");
        }
        return list;
    }
    ...
    public Long countShiroFilter() {
        ...
        if(result==null){
            throw new YmshopException("获取shiro过滤链数目失败");
        }
        return result;
    }
    ...
    public int addShiroFilter(TbShiroFilter tbShiroFilter) {
        ...
        if(tbShiroFilterMapper.insert(tbShiroFilter)!=1){
            throw new YmshopException("添加shiro过滤链失败");
        }
        return 1;
    }
    ...
    public int updateShiroFilter(TbShiroFilter tbShiroFilter) {
        ...
        if(tbShiroFilterMapper.updateByPrimaryKey(tbShiroFilter)!=1){
            throw new YmshopException("更新shiro过滤链失败");
        }
        return 1;
    }
    ...
    public int deleteShiroFilter(int id) {
        ...
        if(tbShiroFilterMapper.deleteByPrimaryKey(id)!=1){
            throw new YmshopException("删除shiro过滤链失败");
        }
        return 1;
    }
    ...
    public TbBase getBase() {
        ...
        if(tbBase==null){
            throw new YmshopException("获取基础设置失败");
        }
        return tbBase;
    }
    ...
    public int updateBase(TbBase tbBase) {
        ...
        if(tbBaseMapper.updateByPrimaryKey(tbBase)!=1){
            throw new YmshopException("更新基础设置失败");
        }
        return 1;
    }
    ...
    public TbOrderItem getWeekHot() {
        ...
        if(list==null){
            throw new YmshopException("获取热销商品数据失败");
        }
        if(list.size()==0){
    ...
    public int addLog(TbLog tbLog) {
        ...
        if(tbLogMapper.insert(tbLog)!=1){
            throw new YmshopException("保存日志失败");
        }
        return 1;
    }
    ...
    public Long countLog() {
        ...
        if(result==null){
            throw new YmshopException("获取日志数量失败");
        }
        return result;
    }
    ...
    public int deleteLog(int id) {
        ...
        if(tbLogMapper.deleteByPrimaryKey(id)!=1){
            throw new YmshopException("删除日志失败");
        }
        return 1;
    }
}
