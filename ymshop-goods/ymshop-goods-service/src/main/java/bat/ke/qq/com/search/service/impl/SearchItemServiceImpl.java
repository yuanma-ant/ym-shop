...
import bat.ke.qq.com.common.utils.HttpUtil;
import bat.ke.qq.com.manager.dto.EsCount;
...
public class SearchItemServiceImpl implements SearchItemService {
	...
	public int importAllItems() {
		...
		try{
			...
			e.printStackTrace();
			throw new YmshopException("导入ES索引库出错，请再次尝试");
		}
	...
	public EsInfo getEsInfo() {
		...
		if(StringUtils.isBlank(healthResult)||StringUtils.isBlank(countResult)){
			throw new YmshopException("连接集群失败，请检查ES运行状态");
		}
		...
		try {
			...
			e.printStackTrace();
			throw new YmshopException("获取ES信息出错");
		}
